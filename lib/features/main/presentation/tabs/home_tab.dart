...
import '../providers/home_webview_providers.dart';
...
class _HomeTabScreenState extends ConsumerState<HomeTabScreen> {
  ...
  HomeWebRequest? _currentRequest;
  ...
  bool _isSameRequest(HomeWebRequest request) {
  ...
  void _loadRequest(HomeWebRequest request) {
        ...
        body: SafeArea(
          child: requestAsync.when(
            ...
            error: (error, stackTrace) => _WebViewErrorView(
              title: l10n.webviewErrorTitle,
              message: l10n.webviewConfigError,
              buttonLabel: l10n.webviewRetryButton,
              onRetry: () => ref.invalidate(homeWebRequestProvider),
            ),
          ),
        ),
      ),
